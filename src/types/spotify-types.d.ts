...
export interface IHandleErrors<T extends Error> {
  handleErrors(error: T): Promise<boolean>;
}

export interface IValidateResponses<T> {
  validateResponse: (response: Response) => Promise<T | null>;
}
